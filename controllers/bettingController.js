...
class bettingController {
  ...
  static placeBet = async (req, res) => {
    try {
      ...
      if (existingBet) {
        return res.status(400).json({ message: "Bet already placed for this match" });
      }
  ...
  static calculatePoints = async (roundSlug, selectedWinner) => {
    try {
      ...
      switch (round.roundNumber) {
        ...
        case 1: points = seedValue; break;
        case 2: points = seedValue * 2; break;
        case 3: points = seedValue * 3; break;
